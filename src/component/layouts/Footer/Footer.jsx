...
const footMenu = [
 ...
 const footSocial = [
   ...
   },
   {
     ...
     path: "https://www.linkedin.com/in/md-monagir-hussan-7140b7266/",
   },
 ];
          ...
          <div className="container_Footer">
            <div className="sub_footer_wrapper">
              ...
              <div className="foot_copyright">
                <p>
                  &copy; {currYear} | MonagirSportsHub, All Rights Reserved.
                  <span>
                    <a href="iam-monagir.tech"> | Built by Iam_Monagir</a>
                  </span>
                </p>
              </div>
            </div>
