    ...
    <>
      <div className={classes.about_us}>
          ...
          <Grid container spacing={4} justifyContent="center">
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body1" className={classes.introText_about}>
                MonagirSportsHub is an online cricket sports selling startup
              ...
              <Typography variant="body1" className={classes.introText_about}>
              MonagirSportsHub was founded by Lokesh Samant, a talented cricket
        ...
        <Container className={classes.container_12}>
          ...
          MonagirSportsHub is dedicated to providing high-quality cricket
          ...
          <Typography variant="body1" className={classes.infoText_about}>
            At MonagirSportsHub, we believe in fostering long-term relationships
        ...
        <Container className={classes.container_12}>
          ...
          <Typography variant="body1" className={classes.infoText_about}>
          MonagirSportsHub is driven by the mission to provide high-quality
